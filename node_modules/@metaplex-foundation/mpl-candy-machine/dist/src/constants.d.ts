...
export declare const CANDY_MACHINE_HIDDEN_SECTION: number;
export declare const CANDY_GUARD_LABEL_SIZE = 6;
export declare const CANDY_GUARD_DATA: number;
export declare const METADATA_SIZE: number;
export declare const MASTER_EDITION_SIZE: number;
