...
import { CollectionDetailsArgs, CreatorArgs, PrintSupplyArgs, ResolvedAccount, ResolvedAccountsWithIndices, TokenStandard } from '../generated';
...
export declare const resolveOptionalTokenOwner: (context: Pick<Context, 'identity'>, accounts: ResolvedAccountsWithIndices, ...rest: any[]) => Partial<ResolvedAccount>;
